...
def get_args():
    ...
    #project name si estás en terminal en la carpeta de la repo solo es '.'
    ...
    parser.add_argument('--checkpoint_root', default='/checkpoints/ChangeFormer_DSIFN', type=str)
    parser.add_argument('--output_folder', default='samples_DSIFN/MY_predict_CD_ChangeFormerV6', type=str)

    # data
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--dataset', default='CDDataset', type=str)
    parser.add_argument('--data_name', default='DSIFN', type=str) #######quick_start_DSIFN
    ...
    parser.add_argument('--net_G', default='ChangeFormerV6', type=str, # base_transformer_pos_s4_dd8_dedim8 | ChangeFormerV6
