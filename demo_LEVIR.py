...
def get_args():
    ...
    parser.add_argument('--checkpoint_root', default='/checkpoints/ChangeFormer_LEVIR', type=str)
    parser.add_argument('--output_folder', default='samples_LEVIR/MY_predict_CD_ChangeFormerV6', type=str)

    # data
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--dataset', default='CDDataset', type=str)
    parser.add_argument('--data_name', default='LEVIR', type=str) ##########quick_start_LEVIR

    parser.add_argument('--batch_size', default=1, type=int)
    parser.add_argument('--split', default="demo", type=str) # default realmente es demo
